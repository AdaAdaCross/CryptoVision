...
namespace CryptoVisionGUI
{
    public partial class Form1 : Form
    {
        ...
        private void DoneVideo_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Ключи шифрования для данного адресата не найдены!");
                return;
            }
            ...
            {
                MessageBox.Show("Не удается открыть файлы!");
                return;
            }
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Не удается открыть аудио!");
                    return;
                }
            }
            ...
            {
                MessageBox.Show("Не удается записать avi файл!");
                return;
            }
        }
        ...
        private void LoadAvi_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Не найдены локальные ключи!");
                return;
            }
            ...
            {
                MessageBox.Show("Не удалось загрузить avi файл!");
            }
            ...
            {
                MessageBox.Show("Загруженный файл поврежден!");
            }
        }
    }
}
